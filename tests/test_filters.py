...
def test_price_and_type():
    gift = StarGiftModel(id=1, title=None, stars=100, limited=False, sold_out=False, type="unlimited")
...
def test_supply_and_sold_out():
    gift = StarGiftModel(id=2, title=None, stars=100, limited=True, sold_out=False,
                         availability_remains=5, type="limited")
