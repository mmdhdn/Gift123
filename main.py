    ...
    async def main(self):
        ...
        try:
            ...
            if not is_test_mode:
                ...
                old_gifts = {i.id for i in old_gifts[:-2] if i.is_limited}  # test cache, 2 gifts
        ...
        self.new_gifts = [{"id": gift.id, "total": gift.total_amount, "price": gift.price} for gift in self.new_gifts]    # получаем саплай и цену для сортировки
